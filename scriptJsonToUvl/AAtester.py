...
def contar_validos(ruta_csv):
    ...
    with open(ruta_csv, mode='r', newline='', encoding='utf-8') as archivo:
        ...
        for fila in lector:
            valid_value = fila["Valid"].strip().lower()
...
# Ejemplo de uso:
suma_total_files = 0
ruta_archivo = './getValidConfig/config_validation_results03_3_json11_FirstConfig.csv'  # Cambia esto por el nombre de tu archivo config_validation_results03_3_json10_FirstConfig
cantidad_true, contador_false, contador_error, contador_invalid = contar_validos(ruta_archivo)
